<template>
  <div class="header">
    <div class="header-top">
      <div class="container">
        <div class="con-left">
          <a href="javascript:;">快乐淘</a>
          <a href="javascript:;">LETO</a>
    ...
    .container {
      ...
      .con-right {
        ...
        .cartbox {
          ...
          margin: 0;
          .icon-cart {
            @include bgImg(16px, 12px, "./../assets/icon-cart-checked.png");
          }
        }
      }
    }
